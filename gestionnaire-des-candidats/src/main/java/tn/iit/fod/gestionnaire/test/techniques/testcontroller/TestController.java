package tn.iit.fod.gestionnaire.test.techniques.testcontroller;
...
import tn.iit.fod.gestionnaire.test.techniques.testrespository.TestRepository;
...
public class TestController {
    ...
    @PostMapping("candidat/test/add")
    public Test addTest(@RequestBody Test test ){
        return repository.save(test);
    }

    @GetMapping("candidat/test/all")
    ...
    @DeleteMapping("candidat/test/{id}")
